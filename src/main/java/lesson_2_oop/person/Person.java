...
public class Person {
    //    1. Создайте класс Window для описания человека. Перечислите в нём поля Идентификатор (числовой),
    //    Имя, Фамилия, Дата рождения, налоговый номер (числовой), Пол

    //    2. В созданном классе Window сделайте поля приватными и добавьте методы доступа с соответствующими проверками.
    //    3. В классе Window создайте все виды конструкторов.
