...
public class Guitar extends MusicalInstr{
...
//    бас-гитара, виолончель, труба, флейта. При необходимости создайте промежуточные абстрактные классы в иерархии.
    ...
    public void play() {
        if (isTuned()){
            System.out.println("i pull the strings");
            counter++;
        }
        else {
            System.out.println("I can't play, guitar is not tuned");
        }
    }
    @Override
    public void tune() {
        System.out.println("I adjust guitar!");
        counter = 0;
    }
    @Override
